...
class LabelTool():
    def __init__(self, master):
        ...
        self.parent.bind("r", self.Rotate) #press 'r' to rotate image
        ...
        self.btnRotate = Button(self.frame, text = 'Rotate', command = self.Rotate)
        self.btnRotate.grid(row = 5, column = 2, sticky = W+E+N)

        self.btnCar = Button(self.frame, text = 'Car', command = self.Car)
        self.btnCar.grid(row = 6, column = 2, sticky = W+E+N)
        self.btnPlate = Button(self.frame, text = 'Plate', command = self.Plate)
        self.btnPlate.grid(row = 7, column = 2, sticky = W+E+N)
        self.btnPeak = Button(self.frame, text = 'Peak', command = self.Peak)
        self.btnPeak.grid(row = 8, column = 2, sticky = W+E+N)
